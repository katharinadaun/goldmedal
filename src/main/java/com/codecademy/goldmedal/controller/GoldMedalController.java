...
public class GoldMedalController {
    ...
    private final GoldMedalRepository medalRepository;

    public GoldMedalController(final CountryRepository countryRepository, final GoldMedalRepository medalRepository) {
